# ==============================================================================
# Backtest - CMO-VHF-STC Strategy mit Advanced Pyramiding & Exit Strategies
# ==============================================================================
...
param_grid <- expand.grid(
  ...
  pyramid_method = c("breakout", "consecutive"),  # "none" wenn use_pyramiding = FALSE
...
for(i in 1:nrow(top_10_params)) {
  cat(sprintf("\n--- Rang %d ---\n", i))
  cat(sprintf("Pyramid: %s | Exit: %s | TP: %s\n", 
