# MCPT - FRAMA + VHF (Vertical Horizontal Filter) Strategy
...
cat("\n")
cat("########################################################################\n")
cat("#      MCPT für FRAMA + VHF (Vertical Horizontal Filter) mit Pyramiding                      #\n")
cat("########################################################################\n\n")
...
source(file.path("/home/user/R-ML-Trading-Complete/backtest_strategies/FRAMA_VHF", "03_backtest_FRAMA_VHF_pyramiding.R"))
