# MCPT - Coppock + Multi-ROC Alignment Strategy
...
cat("\n")
cat("########################################################################\n")
cat("#      MCPT für Coppock + Multi-ROC Alignment mit Pyramiding                      #\n")
cat("########################################################################\n\n")
...
source(file.path("/home/user/R-ML-Trading-Complete/backtest_strategies/Coppock_ROC", "03_backtest_Coppock_ROC_pyramiding.R"))
