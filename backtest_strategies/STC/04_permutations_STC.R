# MCPT - Schaff Trend Cycle (STC) Strategy
...
cat("\n")
cat("########################################################################\n")
cat("#      MCPT für Schaff Trend Cycle (STC) mit Pyramiding                      #\n")
cat("########################################################################\n\n")
...
source(file.path("/home/user/R-ML-Trading-Complete/backtest_strategies/STC", "03_backtest_STC_pyramiding.R"))
