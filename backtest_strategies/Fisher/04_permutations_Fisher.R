# MCPT - Ehlers Fisher Transform Strategy
...
cat("\n")
cat("########################################################################\n")
cat("#      MCPT für Ehlers Fisher Transform mit Pyramiding                      #\n")
cat("########################################################################\n\n")
...
source(file.path("/home/user/R-ML-Trading-Complete/backtest_strategies/Fisher", "03_backtest_Fisher_pyramiding.R"))
